...
class SauresHA:
    ...
    # 4.0 - контроллер R2 (4.0) 8 аналоговых каналов
    # 4.5 - контроллер R2 (4.5) 8 аналоговых каналов с клеммами для подключения внешнего питания
    ...
    def get_controller_name(self, version_id):
        return {
            True: "неизвестный контроллер (%s)" % version_id,
            version_id == "1.3"
            or version_id == "1.4"
            ...
            version_id == "4.0": "контроллер R2 (4.0)",
            version_id == "4.5": "контроллер R2 (4.5)",
